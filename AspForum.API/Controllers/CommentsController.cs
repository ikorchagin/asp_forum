...
namespace AspForum.API.Controllers
{
    ...
    public class CommentsController : ControllerBase
    {
        ...
        {
            _context = context;
            _context.Comments.Include(comment => comment.Article).ToList();
        }
        ...
        public async Task<ActionResult<IEnumerable<CommentViewModel>>> GetComments(int articleId)
        {
            ...
            return await _context.Comments.Where(comment => comment.ArticleId == articleId)
                .Select(comment => new CommentViewModel(comment)).ToListAsync();
        }
